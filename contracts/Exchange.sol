...
contract Exchange is ERC20 {
    ...
    event TokenPurchase(
        ...
        uint256 indexed etherSold,
        uint256 indexed tokensBought
    );
    event EtherPurchase(
        address indexed buyer,
        uint256 indexed tokensSold,
        uint256 indexed etherBought
    );
    event AddLiquidity(
    ...
    function removeLiquidity(
        ...
        tokenAmount =
            (token.balanceOf(address(this)) * lpTokenAmount) /
            totalLiquidity;
    ...
    function getInputPrice(
        ...
        outputAmount = (outputAmountWithFee * 967) / 1000; // CSMM
    }
    ...
    function getOutputPrice(
        ...
        uint inputAmountWithFee = numerator / denominator;
        inputAmount = (inputAmountWithFee * 1000) / 967; // CSMM
    }
